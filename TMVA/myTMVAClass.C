...
void myTMVAClass( TString myMethodList = "" )
{
   ...
   // factory->AddVariable( "Jet_Pt3", 'F' );
   // factory->AddVariable( "Jet_Pt4", 'F' );
   // factory->AddVariable( "Jet_btag1", 'F' );
   // factory->AddVariable( "Jet_btag2", 'F' );
   // factory->AddVariable( "Jet_btag3", 'F' );
   // factory->AddVariable( "Jet_btag4", 'F' );
   ...
   factory->AddSpectator( "spec1 := nBJet",  "Spectator B-Tagging", "units", 'I' );

   // !!!
   // Read training and test data
   TFile *sigFile = TFile::Open( "mva_ttbar.root" );
   TFile *bkgFile1 = TFile::Open( "mva_dy.root" );
   TFile *bkgFile2 = TFile::Open( "mva_wjets.root" );
   TFile *bkgFile3 = TFile::Open( "mva_qcd.root" );
   ...
   factory->AddBackgroundTree( background1, 1.0 );
   factory->AddBackgroundTree( background2, 1.0 );
   factory->AddBackgroundTree( background3, 1.0 );
